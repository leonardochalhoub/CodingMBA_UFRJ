...
# MAGIC %sql
# MAGIC CREATE TABLE main.db_bronze_dev.RAIS_VINC_PUB_2021 (
# MAGIC   ano VARCHAR(4),
...
# Define the separator used in the files
separator = ";"  # Replace with the actual separator used in your files
...
df_cleaned.write.format("delta").mode("overwrite").saveAsTable("main.db_bronze_dev.RAIS_VINC_PUB_2021")
